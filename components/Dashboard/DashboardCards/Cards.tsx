...
import {
  ...
  import cardSend from "@/public/Dashboard_Icons/card-send.svg"

const AnalyticDashboardCards = () => {
      ...
      const cardData = [
        ...
        {title: '$15K', subTitle: 'Debt', icon: cardSend},
      ]
...
export default AnalyticDashboardCards