...
import {
  ...
  import userTick from "@/public/Dashboard_Icons/user-tick.svg"

const AnalyticLoansCards = () => {
  ...
  return (
    ...
    <div className="grid gap-5 mt-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {cardData.slice(0, 4).map((data, id) => (
...
export default AnalyticLoansCards