...
import DistressedTable from '@/components/Loans/DistressedTable/DistressedTable'
    ...
    <div className='p-5'>
        <Card className='border-0 shadow-none flex flex-col md:flex-row md:items-center justify-between'>
            <CardHeader className='p-0 pt-5'>
                <CardTitle className='text-[32px] text-[#1A1C21]'>Distressed Loans</CardTitle>
                <CardDescription className='text-[16px] text-[#667085]'>Here’s what happening with your Distressed Loans</CardDescription>
            </CardHeader>
        </Card>
